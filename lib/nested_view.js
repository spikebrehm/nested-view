...
(function(){
  ...
  var NestedView = Backbone.View.extend({
    ...
    initialize: function(){
      this.childViews = {};
      this.postInitialize();
      console.log('INITIALIZE:', this.name, this.globals);
    },
  ...
  NestedView.viewHelper = function(context, options) {
    ...
    var viewOptions = NestedView._getViewOptions( context, options );
  ...
  NestedView._getViewOptions = function ( context, options ) {
