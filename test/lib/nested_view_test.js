...
describe('NestedView', function(){
  ...
  describe('getHtml()', function(){
    it('should return the outerHtml of a single view', function(){
      ...
      assert.equal(html, '<div data-view="inner_view" class="inner">Name: Spike<br>Email: spike@email.com</div>');
    });
    ...
    it('should return the html of a nested view', function(){
      ...
      assert.equal(html,
        '<section data-view="outer_view" class="outer"><h1>Hello, Spike.</h1>' +
        '<div data-view="inner_view" class="inner">Name: Spike<br>Email: spike@email.com</div></section>'
      );
    });
  });
